    ...
    if form.validate_on_submit():
        ...
        if user:
            ...
            try:
                ...
                subject = 'Welcome to Campze - Please Verify Your Email'
...
def resend_verification_token():
    ...
    return render_template('auth/resend_verification_token.html', form=form)
    ...
    if form.validate_on_submit():
        ...
        if user:
            ...
            if user.check_password(password):
                ...
                elif user.role == 'parent' or user.role == 'guardian':
